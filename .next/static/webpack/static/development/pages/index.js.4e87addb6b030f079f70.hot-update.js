...
function (_React$Component) {
  ...
  function Signature(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_8__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6__["default"])(_this), "tabs", _babel_runtime_corejs2_core_js_object_freeze__WEBPACK_IMPORTED_MODULE_1___default()({
    ...
    value: function render() {
      ...
      return __jsx(react__WEBPACK_IMPORTED_MODULE_9___default.a.Fragment, null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_12___default.a, {
        ...
        className: classnames__WEBPACK_IMPORTED_MODULE_11___default()({
          active: this.state.activeTab === 'type-it-in'
        }),
        onClick: function onClick() {
          _this2.toggle('type-it-in');
        },
        tag: "button",
        __source: {
          fileName: _jsxFileName,
        ...
        tag: "button",
        className: classnames__WEBPACK_IMPORTED_MODULE_11___default()({
          active: this.state.activeTab === 'draw-it'
        }),
        onClick: function onClick() {
          _this2.toggle('draw-it');
        },
        __source: {
          fileName: _jsxFileName,
          lineNumber: 76
...
//# sourceMappingURL=index.js.4e87addb6b030f079f70.hot-update.js.map